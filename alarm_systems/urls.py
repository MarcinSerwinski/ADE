...
urlpatterns = [
    ...
    path('main_view/delete_camera/<int:camera_id>', views.delete_camera,
         name='delete_camera'),
    path('main_view/delete_motionsensor/<int:motionsensor_id>', views.delete_motionsensor,
         name='delete_motionsensor'),
    path('main_view/delete_central/<int:central_id>', views.delete_central,
         name='delete_central'),
    path('main_view/delete_registrator/<int:registrator_id>', views.delete_registrator,
         name='delete_registrator'),
    path('main_view/delete_system/<int:system_id>', views.delete_system,
         name='delete_system'),
