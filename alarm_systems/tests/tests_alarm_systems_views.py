...
def test_access_to_mainview(client, user):
...
def test_add_customer_get(client, user):
    client.force_login(user)
...
def test_add_customer_post(db, client, user):
    client.force_login(user)
...
def test_delete_customer_get(db, client, customer_id, user):
    client.force_login(user)
...
def test_delete_customer_post(db, client, customer_id, user):
    client.force_login(user)
...
def test_user_not_logged_to_delete_customer(db, client, customer_id):
    endpoint = reverse('alarm_systems:delete_customer', kwargs={'customer_id': customer_id})
    response = client.get(endpoint)
    assert response.status_code == 302
...
def test_edit_customer_get(db, client, user, customer_id):
    client.force_login(user)
...
def test_edit_customer_post(db, client, user, customer_id):
    client.force_login(user)
...
def test_details_customer_get(db, client, customer_id, user):
    client.force_login(user)
...
def test_user_not_logged_to_details_customer(db, client, customer_id, user):
    endpoint = reverse('alarm_systems:details_customer', kwargs={'customer_id': customer_id})
    response = client.get(endpoint)
    assert response.status_code == 302
    assert response.url.startswith(reverse('users:login_view'))
...
def test_add_location_get(db, client, user, customer_id):
    client.force_login(user)
...
def test_add_location_post(db, client, user, customer_id):
    client.force_login(user)
...
def test_delete_location_get(db, client, user, customer_id, location_customers_id):
    client.force_login(user)
...
def test_edit_location_get(db, client, customer_id, user, location_customers_id):
    client.force_login(user)
...
def test_edit_location_post(db, client, user, customer_id, location_customers_id):
    client.force_login(user)
...
def test_details_location_get(db, client, user, customer_id, location_customers_id):
    client.force_login(user)
...
def test_add_system_for_location_get(db, client, user, customer_id, location_customers_id):
    client.force_login(user)
...
def test_add_system_for_location_post(db, client, user, customer_id, location_customers_id):
    client.force_login(user)
...
def test_edit_system_name_get(db, client, user, system_id):
    client.force_login(user)
...
def test_edit_system_name_post(db, client, user, customer_id, location_customers_id, system_id):
    client.force_login(user)
...
def test_delete_system_get(db, client, user, customer_id, location_customers_id, system_id):
    client.force_login(user)
...
def test_details_system_when_empty_get(db, client, user, system_id):
    client.force_login(user)
...
def test_details_system_with_video_surveillance_get(db, client, user, system_id, create_system):
    client.force_login(user)
    endpoint = reverse('alarm_systems:details_system', kwargs={'system_id': system_id})
...
def test_details_system_with_alarm_get(db, client, user, system_id, create_system):
    client.force_login(user)
    endpoint = reverse('alarm_systems:details_system', kwargs={'system_id': system_id})
...
def test_add_registrator_get(db, client, user, system_id):
    client.force_login(user)
...
def test_add_registrator_post(db, client, user, system_id):
    client.force_login(user)
...
def test_delete_registrator_get(db, client, user, system_id, registrator_id):
    client.force_login(user)
...
def test_edit_registrator_get(db, client, user, system_id, registrator_id):
    client.force_login(user)
...
def test_edit_registrator_post(db, client, user, system_id, registrator_id):
    client.force_login(user)
...
def test_add_camera_get(db, client, user, system_id):
    client.force_login(user)
...
def test_add_camera_post(db, client, user, system_id, registrator_id):
    client.force_login(user)
...
def test_edit_camera_get(db, client, user, system_id, create_camera):
    client.force_login(user)
...
def test_edit_camera_post(db, client, user, system_id, registrator_id, create_camera):
    client.force_login(user)
...
def test_delete_camera_get(db, client, user, system_id, create_camera):
    client.force_login(user)
...
def test_add_central_get(db, client, user, system_id):
    client.force_login(user)
...
def test_add_central_post(db, client, user, system_id):
    client.force_login(user)
...
def test_delete_central_get(db, client, user, system_id, central_id):
    client.force_login(user)
...
def test_edit_central_get(db, client, user, system_id, central_id):
    client.force_login(user)
...
def test_edit_central_post(db, client, user, system_id, central_id):
    client.force_login(user)
...
def test_add_motionsensor_get(db, client, user, system_id):
    client.force_login(user)
...
def test_add_motionsensor_post(db, client, user, system_id, central_id):
    client.force_login(user)
...
def test_edit_motionsensor_get(db, client, user, system_id, create_motionsensor):
    client.force_login(user)
...
def test_edit_motionsensor_post(db, client, user, system_id, central_id, create_motionsensor):
    client.force_login(user)
...
def test_delete_motionsensor_get(db, client, user, system_id, create_motionsensor):
    client.force_login(user)
...
def test_empty_system_get(db, client, user, system_id):
    client.force_login(user)
...
def test_send_email_page(db, client, user, customer_id):
    client.force_login(user)
